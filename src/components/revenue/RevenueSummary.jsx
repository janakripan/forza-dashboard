      ...
      <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 mb-6">
        ...
        <div className="flex flex-col sm:flex-row gap-4 w-full lg:w-auto">
          <form
            ...
            className="relative flex-1 sm:min-w-[400px]"
          >
            <Search
          ...
          <div className="relative">
            <div className="absolute left-3 top-1/2 -translate-y-1/2 flex items-center gap-2 pointer-events-none">
              ...
              <span className="text-[12px] font-semibold text-[#64748B] uppercase">
                Transaction Type
              </span>
            </div>
            <select
      ...
      <div className="flex flex-col md:flex-row gap-5">
        <div className="flex-[1.5] bg-[#F1F5F9] border border-[#E2E8F0] rounded-xl p-6 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h2 className="text-[32px] font-black text-[#1E293B]">
              ...
              <div className="flex items-center gap-2 mt-1">
                ...
                <span className="text-[13px] font-medium text-[#64748B]">
                  ...
                  <span className="font-bold">
                    {revenueSummaryData.invoiceCount}
                  </span>
                </span>
              </div>
            </div>
